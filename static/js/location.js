...
d3.json("/location_conns").then(function (data) {
    characters = {};
    // Extract characters
...
function displayAllLocations() {
    ...
    for (let chap in all_chap_conns) {
        ...
        for(var locationA in all_conns){
        for(var locationB in all_conns[locationA]){
            all_conns[locationA][locationB] /= 2;   // Avoiding too large value
        }
    }
